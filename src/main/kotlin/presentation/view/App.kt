...
fun App() {
    MaterialTheme {
        ...
        Row {
            ...
            DetailView(Modifier.weight(1f).background(Color.White).fillMaxHeight(), list.getOrNull(selectedCourseIndex), onEditCourseNameClicked = { openEditCourseNameDialog = true })
        }
